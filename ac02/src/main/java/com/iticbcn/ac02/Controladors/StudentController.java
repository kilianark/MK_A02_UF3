...
public class StudentController {
    ...
    @GetMapping("/lastname/{regex}")
    public Flux<Student> findByLastnameMatchingRegex(@PathVariable String regex) {
        return studentServei.findByLastnameMatchingRegex(regex);
    }
